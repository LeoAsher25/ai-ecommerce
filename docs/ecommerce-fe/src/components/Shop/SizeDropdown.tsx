  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      <div className={`flex-wrap gap-2.5 p-6 ${toggleDropdown ? 'flex' : 'hidden'}`}>
        <label
          htmlFor="sizeM"
          className="cursor-pointer select-none flex items-center rounded-md bg-primary text-white hover:bg-primary hover:text-white"
        >
        ...
        <label
          htmlFor="sizeL"
          className="cursor-pointer select-none flex items-center rounded-md hover:bg-primary hover:text-white"
        >
          <div className="relative">
