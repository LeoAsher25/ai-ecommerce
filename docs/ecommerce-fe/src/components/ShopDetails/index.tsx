...
import IcLikeCircle from '@/app/assets/icons/IcLikeCircle'
...
import RenderCkEditorContent from '../Common/RenderCkEditorContent'
...
const ShopDetails = ({ product }: IShopDetailsProps) => {
  const [activeColor, setActiveColor] = useState('blue')
  const { openPreviewModal, setImagesList } = usePreviewSlider()
  ...
  return (
    <>
      <Breadcrumb
        ...
        items={[
          { name: 'Cửa hàng', path: APP_ROUTES.SHOP },
          { name: 'Chi tiết sản phẩm', path: '' },
        ]}
      />
      ...
      {product?.name === '' ? (
        ...
        <>
          <section className="overflow-hidden relative pb-20 pt-4 lg:p-6">
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                <div className="lg:max-w-[570px] w-full">
                  <div className="relative lg:min-h-[512px] rounded-lg overflow-hidden shadow-2 bg-gray-2 flex items-stretch justify-center">
                    <div className="flex-1">
                      ...
                      <Image
                        src={resolveImageUrl(product?.images[previewImg])}
                    ...
                    {product?.originalPrice && (
                      <div className="absolute top-4 left-4 inline-flex font-medium text-base text-white bg-primary rounded py-0.5 px-2.5 whitespace-nowrap">
                        {Number(
                ...
                <div className="max-w-[539px] w-full">
                  ...
                  <h3 className="font-medium text-custom-1 mb-4.5">
                    <span className="text-base lg:text-lg text-dark">
                      Giá: {formatPrice(product?.sellingPrice)}{' '}
                    </span>
                    {product?.originalPrice && (
                      <span className="text-base lg:text-lg line-through">
                        {' '}
                  ...
                  <ul className="flex flex-col gap-2">
                    ...
                    <li className="flex items-center gap-2.5">
                      <IcLikeCircle />
                      Hoàn tiền 100% nếu sản phẩm kém chất lượng
                    </li>
                  </ul>

                  <div className="flex flex-col gap-4.5 border-t border-gray-3 mt-5 mb-6"></div>
          ...
          <section className="overflow-hidden bg-gray-2 pt-10 pb-16">
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              {/* <!--== tab header start ==--> */}
                ...
                {tabs.map((item, key) => (
                  <button
                    ...
                    className={`font-medium lg:text-lg ease-out duration-200 hover:text-primary relative before:h-0.5 before:bg-primary before:absolute before:left-0 before:bottom-0 before:ease-out before:duration-200 hover:before:w-full ${
                      activeTab === item.id ? 'text-primary before:w-full' : 'text-dark before:w-0'
                    }`}
                  >
                    {item.title}
                  </button>
              ...
              <div className="content-wrap mt-8">
                ...
                <div>
                  ...
                  >
                    {/* <pre className="text-sm text-dark whitespace-pre-wrap">
                      {product?.description}
                    </pre> */}
                    {/* <div
                    ...
                    /> */}
                    <RenderCkEditorContent content={product?.description} />
                  </div>
                </div>
                {/* <!-- tab content one end --> */}
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                      ...
                      <div className="w-full">
                        <p className="text-sm sm:text-base text-dark">
                          Super Retina XDR OLED, HDR10, Dolby Vision, 800 nits (HBM), 1200 nits
                          (peak)
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5">
                      ...
                      <div className="w-full">
                        <p className="text-sm sm:text-base text-dark">
                          Li-Ion 4323 mAh, non-removable | 15W wireless (MagSafe), 7.5W wireless
                          (Qi)
                        </p>
                      </div>
                    </div>
          ...
          <RecentlyViewdItems categories={product?.categories} />
