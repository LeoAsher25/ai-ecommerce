...
const QuickViewModal = () => {
  ...
  return (
    <Modal open={isModalOpen} onClose={closeModal} contentClassName="!max-w-[1100px]">
      <div className="mx-auto flex flex-col lg:flex-row flex-wrap items-center gap-12.5">
        <div className="w-full lg:w-[526px]">
          <div className="flex gap-5 flex-col-reverse md:flex-row">
            <div className="flex md:flex-col gap-2 md:gap-5 overflow-auto md:overflow-visible">
              {product?.images?.map((img, key) => (
                <button
                  onClick={() => setActivePreview(key)}
                  key={key}
                  className={`flex items-center justify-center min-w-[60px] w-15 h-15 md:min-w-[80px] md:w-20 md:h-20 overflow-hidden rounded-lg bg-gray-1 ease-out duration-200 hover:border-2 hover:border-primary ${
                    activePreview === key && 'border-2 border-primary'
                  }`}
                >
                  <Image
            ...
            <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
              <div className="flex items-center justify-center">
                <button
                  ...
                  className="gallery__Image w-10 h-10 rounded-[5px] bg-white shadow-3 flex items-center justify-center ease-out duration-200 text-dark hover:text-primary absolute top-4 lg:top-8 right-4 lg:right-8 z-50"
                >
                  <svg
                ...
                <Image
                  ...
                  width={400}
                  height={400}
                  className="m-auto w-full h-auto object-container object-center"
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 lg:mr-10">
          ...
          <h3 className="font-semibold text-xl xl:text-heading-5 text-dark mb-4 line-clamp-1">
            {product?.name}
          </h3>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-[5px] bg-gray-2 text-dark ease-out duration-200 hover:text-primary"
