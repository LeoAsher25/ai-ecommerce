...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={'Giỏ hàng'} items={[{ name: 'Giỏ hàng', path: APP_ROUTES.CART }]} />
      </section>
      {/* <!-- ===== Breadcrumb Section End ===== --> */}
      {cartItems.length > 0 ? (
        <section className="overflow-hidden pt-6 pb-16 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-6">
              <h2 className="font-medium text-dark text-2xl">Giỏ hàng của bạn</h2>
              <button className="text-primary">Xóa tất cả</button>
            </div>

            <div className="bg-white rounded-[10px] shadow-1">
              <div className="w-full overflow-x-auto">
                <div className="flex-1 min-w-[1170px]">
                  {/* <!-- table header --> */}
                  <div className="flex items-center py-5.5 px-7.5 gap-4">
