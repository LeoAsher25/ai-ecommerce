...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5 gap-4">
      <div className="flex-1 min-w-[500px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-[5px] bg-gray-2 max-w-[80px] w-full h-17.5">
              <Image width={200} height={200} src={resolveImageUrl(item.images[0])} alt="product" />
            </div>
      ...
      <div className="flex-1 min-w-[100px]">
        <p className="text-dark">{formatPrice(item.sellingPrice * quantity)}</p>
      </div>
