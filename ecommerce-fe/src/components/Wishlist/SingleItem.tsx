  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
        ...
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-[5px] bg-gray-2 max-w-[80px] w-full h-17.5">
              <Image src={resolveImageUrl(item.images[0])} alt="product" width={200} height={200} />
            </div>
      ...
      <div className="min-w-[205px]">
        <p className="text-dark">${formatPrice(item.sellingPrice)}</p>
      </div>
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex text-dark hover:text-white bg-gray-1 border border-gray-3 py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-primary hover:border-gray-3"
        >
          Add to Cart
        </button>
      </div>
