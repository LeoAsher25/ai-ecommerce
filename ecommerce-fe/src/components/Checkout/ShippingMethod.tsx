        ...
        <div className="flex flex-col gap-4">
          <label htmlFor="free" className="flex cursor-pointer select-none items-center gap-3.5">
            <div className="relative">
              ...
              />
              {/* selectShipping === 'free' ? 'border-4 border-primary' : 'border border-gray-4' */}
              <div
                className={`flex h-4 w-4 items-center justify-center rounded-full ${
                  shippingMethod === 'free' ? 'border-4 border-primary' : 'border border-gray-4'
                }`}
              ></div>
            </div>
            Free Shipping
          ...
          <label htmlFor="fedex" className="flex cursor-pointer select-none items-center gap-3.5">
            <div className="relative">
              ...
              <div
                className={`flex h-4 w-4 items-center justify-center rounded-full ${
                  shippingMethod === 'fedex' ? 'border-4 border-primary' : 'border border-gray-4'
                }`}
              ></div>
            </div>
          ...
          <label htmlFor="dhl" className="flex cursor-pointer select-none items-center gap-3.5">
            <div className="relative">
              ...
              <div
                className={`flex h-4 w-4 items-center justify-center rounded-full ${
                  shippingMethod === 'dhl' ? 'border-4 border-primary' : 'border border-gray-4'
                }`}
              ></div>
            </div>
